    ...
    return (
      <div
        ...
        className={clsx(
          ...
          "prose prose-lg max-w-none mb-[56px] font-space-grotesk",
          // Remove default prose styles
          "[&_*]",
          // Markdown Post Content Styles
          // h1 styles
          "[&_h1]:!text-markdown-h1 [&_h1]:!font-bold [&_h1]:!text-neutral-black [&_h1]:!leading-[1.5] [&_h1]:!align-middle [&_h1]:!m-0 [&_h1]:!mb-3",
          // p styles - override prose defaults completely
          "[&_p]:!text-[16px] [&_p]:!font-normal [&_p]:!text-[#595959] [&_p]:!leading-[1.8] [&_p]:md:!leading-[1.7] [&_p]:!align-middle [&_p]:!tracking-[0px] [&_p]:!m-0",
          // p with mb-large class - margin bottom 64px
          "[&_p.mb-large]:!mb-16",
          // span inside p styles (for underlined text)
          "[&_p_span]:!text-[16px] [&_p_span]:!font-normal [&_p_span]:!text-markdown-text-underline [&_p_span]:!leading-[1.8] [&_p_span]:!align-middle [&_p_span]:!underline [&_p_span]:!tracking-[0px]",
          ...
          "[&_blockquote_p]:!text-[19px] [&_blockquote_p]:!md:text-[21px] [&_blockquote_p]:!font-bold [&_blockquote_p]:!text-neutral-black [&_blockquote_p]:!leading-[1.5] [&_blockquote_p]:!align-middle [&_blockquote_p]:!tracking-[0px] [&_blockquote_p]:!m-0",
